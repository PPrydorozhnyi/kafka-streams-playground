...
public class BalanceProcessor {
    ...
    public void buildPipeline(
        ...
        builder.stream(inTopic, Consumed.with(Serdes.String(), balanceChangeSerde))
                ...
                .groupByKey(Grouped.<String, BalanceChangeEvent>as("grouped-by-name")
                        .withValueSerde(balanceChangeSerde))
                .aggregate(
                ...
                .to(
                        outTopic,
                        Produced.<String, BalanceStateEvent>as("updated-balances")
                                .withValueSerde(balanceStateSerde));
    }
