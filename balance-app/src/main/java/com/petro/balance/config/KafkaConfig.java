...
public class KafkaConfig {
  ...
  @Bean
  public ProducerFactory<String, BalanceChangeEvent> resultProducerConfigFactory(KafkaProperties kafkaProperties,
                                                                                 ObjectMapper objectMapper) {
    final var valueSerializer = new JsonSerializer<BalanceChangeEvent>(objectMapper);
    return new DefaultKafkaProducerFactory<>(kafkaProperties.buildProducerProperties(), null, valueSerializer);
  }
